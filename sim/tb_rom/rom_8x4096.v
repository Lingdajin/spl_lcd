...
/* Module Version: 5.4 */
/* D:\Program\Diamond\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n rom_8x4096 -lang verilog -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 00 -rp 1100 -addr_width 12 -data_width 8 -num_rows 4096 -outdata REGISTERED -cascade -1 -resetmode SYNC -sync_reset -memfile d:/codefield/verilog/diamond_design/spi_lcd/source/rom_8x4096.mem -memformat orca  */
/* Wed Jan 15 21:43:43 2025 */


`timescale 1 ns / 1 ps
module rom_8x4096 (Address, OutClock, OutClockEn, Reset, Q)/* synthesis NGD_DRC_MASK=1 */;
    ...
    DP8KC rom_8x4096_0_0_3 (.DIA8(scuba_vlo), .DIA7(scuba_vlo), .DIA6(scuba_vlo), 
        ...
        .DOB4(), .DOB3(), .DOB2(), .DOB1(), .DOB0())
             /* synthesis MEM_LPC_FILE="rom_8x4096.lpc" */
             /* synthesis MEM_INIT_FILE="rom_8x4096.mem" */;
    ...
    DP8KC rom_8x4096_0_1_2 (.DIA8(scuba_vlo), .DIA7(scuba_vlo), .DIA6(scuba_vlo), 
        .DIA5(scuba_vlo), .DIA4(scuba_vlo), .DIA3(scuba_vlo), .DIA2(scuba_vlo), 
        .DIA1(scuba_vlo), .DIA0(scuba_vlo), .ADA12(Address[11]), .ADA11(Address[10]), 
        .ADA10(Address[9]), .ADA9(Address[8]), .ADA8(Address[7]), .ADA7(Address[6]), 
        .ADA6(Address[5]), .ADA5(Address[4]), .ADA4(Address[3]), .ADA3(Address[2]), 
    ...
    DP8KC rom_8x4096_0_2_1 (.DIA8(scuba_vlo), .DIA7(scuba_vlo), .DIA6(scuba_vlo), 
        .DIA5(scuba_vlo), .DIA4(scuba_vlo), .DIA3(scuba_vlo), .DIA2(scuba_vlo), 
        .DIA1(scuba_vlo), .DIA0(scuba_vlo), .ADA12(Address[11]), .ADA11(Address[10]), 
        .ADA10(Address[9]), .ADA9(Address[8]), .ADA8(Address[7]), .ADA7(Address[6]), 
        .ADA6(Address[5]), .ADA5(Address[4]), .ADA4(Address[3]), .ADA3(Address[2]), 
    ...
    DP8KC rom_8x4096_0_3_0 (.DIA8(scuba_vlo), .DIA7(scuba_vlo), .DIA6(scuba_vlo), 
        .DIA5(scuba_vlo), .DIA4(scuba_vlo), .DIA3(scuba_vlo), .DIA2(scuba_vlo), 
        .DIA1(scuba_vlo), .DIA0(scuba_vlo), .ADA12(Address[11]), .ADA11(Address[10]), 
        .ADA10(Address[9]), .ADA9(Address[8]), .ADA8(Address[7]), .ADA7(Address[6]), 
        .ADA6(Address[5]), .ADA5(Address[4]), .ADA4(Address[3]), .ADA3(Address[2]), 
    ...
    // exemplar begin
    // exemplar attribute rom_8x4096_0_0_3 MEM_LPC_FILE rom_8x4096.lpc
    // exemplar attribute rom_8x4096_0_0_3 MEM_INIT_FILE rom_8x4096.mem
    // exemplar attribute rom_8x4096_0_1_2 MEM_LPC_FILE rom_8x4096.lpc
    // exemplar attribute rom_8x4096_0_1_2 MEM_INIT_FILE rom_8x4096.mem
    // exemplar attribute rom_8x4096_0_2_1 MEM_LPC_FILE rom_8x4096.lpc
    // exemplar attribute rom_8x4096_0_2_1 MEM_INIT_FILE rom_8x4096.mem
    // exemplar attribute rom_8x4096_0_3_0 MEM_LPC_FILE rom_8x4096.lpc
    // exemplar attribute rom_8x4096_0_3_0 MEM_INIT_FILE rom_8x4096.mem
    // exemplar end
